...
reset:
	...
	ldx #0			; Initialize x offest register
print:
	lda message,x
	beq loop		; If a register is zero, branch equal will jump out of the print loop.
	jsr print_char
	inx
	jmp print
...
message: .asciiz "Hello, world"	; Puts null byte (x00) art end of string.
